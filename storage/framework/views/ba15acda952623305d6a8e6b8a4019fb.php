...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.table','data' => ['headers' => ['Nome', 'Natureza', 'Estoque', 'Status', 'Ações'],'records' => $assistiveTechnologies]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Nome', 'Natureza', 'Estoque', 'Status', 'Ações']),'records' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($assistiveTechnologies)]); ?>
    <?php $__empty_1 = true; $__currentLoopData = $assistiveTechnologies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($tech->name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($tech->is_digital ? 'Digital' : 'Físico'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b)): ?>
<?php $attributes = $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b; ?>
<?php unset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b); ?>
...
<?php $component->withAttributes([]); ?>
                <?php if($tech->is_digital): ?>
                    <span class="text-info fw-bold text-uppercase" style="font-size: 0.85rem;">Ilimitado</span>
                <?php else: ?>
                    <span class="<?php echo e($tech->quantity_available > 0 ? 'text-success' : 'text-danger'); ?> fw-bold">
                        <?php echo e($tech->quantity_available ?? 0); ?>

                    </span>
                    <span class="text-muted">/ <?php echo e($tech->quantity ?? 0); ?></span>
                <?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <span class="text-<?php echo e($color); ?> fw-bold text-uppercase" style="font-size: 0.85rem;">
                    <?php echo e($label); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttons.link-button','data' => ['href' => route('assistive-technologies.show', $tech),'variant' => 'info']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('assistive-technologies.show', $tech)),'variant' => 'info']); ?>
...
<?php endif; ?>
                    ...
                    <form action="<?php echo e(route('assistive-technologies.destroy', $tech)); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttons.submit-button','data' => ['variant' => 'danger','onclick' => 'return confirm(\'Deseja remover esta tecnologia?\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'danger','onclick' => 'return confirm(\'Deseja remover esta tecnologia?\')']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/pages/assistive-technologies/partials/table.blade.php ENDPATH**/ ?>