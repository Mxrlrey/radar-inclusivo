<?php $__env->startSection('title', 'Tecnologias Assistivas'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.page-header','data' => ['title' => 'Tecnologias Assistivas','subtitle' => 'Gerenciamento de periféricos, softwares e equipamentos de acessibilidade.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Tecnologias Assistivas','subtitle' => 'Gerenciamento de periféricos, softwares e equipamentos de acessibilidade.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttons.link-button','data' => ['href' => route('assistive-technologies.create'),'variant' => 'new','title' => 'Adicionar Tecnologias Assistivas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('assistive-technologies.create')),'variant' => 'new','title' => 'Adicionar Tecnologias Assistivas']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.filters.form','data' => ['dataDynamicFilter' => true,'dataTarget' => '#assistive-technologies-table','fields' => [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-dynamic-filter' => true,'data-target' => '#assistive-technologies-table','fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                    ['name' => 'name', 'placeholder' => 'Filtrar por nome...'],
                    ['name' => 'is_digital', 'type' => 'select', 'options' => [
                        '' => 'Natureza (Todos)',
                        '1' => 'Digital',
...
<?php endif; ?>
        ...
        <div id="assistive-technologies-table" class="p-3">
            <?php echo $__env->make('pages.assistive-technologies.partials.table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/pages/assistive-technologies/index.blade.php ENDPATH**/ ?>